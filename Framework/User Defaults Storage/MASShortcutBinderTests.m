...
- (void) testInitialValueReading
{
    ...
    MASDictionaryTransformer *transformer = [[MASDictionaryTransformer alloc] init];
    NSDictionary<NSString*,id>*shortcutDict = [transformer reverseTransformedValue:shortcut];
    [_defaults setObject:shortcutDict forKey:SampleDefaultsKey];
